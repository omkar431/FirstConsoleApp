...
namespace Project01_Introduction
{
    ...
    class L1_Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please provide your value for n");
            string val_n = Console.ReadLine()
            int n = Convert.ToInt32(val_n);
            int a = n % 2;
            if (a > 0)
            {
                Console.WriteLine("Provided Number is Odd");
            }
            else
            {
                Console.WriteLine("Provided Number is Even");
            }
